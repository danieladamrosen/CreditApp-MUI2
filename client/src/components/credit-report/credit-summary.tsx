...
export function CreditSummary({ creditData }: CreditSummaryProps) {
  ...
  const calculateBureauSummary = (bureauName: string): BureauSummary => {
    ...
    console.log(`📋 Credit Summary calculating for bureau: ${bureauName} (${bureauCode})`);
    ...
    const bureauAccounts = accounts.filter((account: any) => {
      ...
      console.log(`📋 Account ${account['@CreditLiabilityID']} → ${bureauCode}:`, bureauData.reporting);
  ...
  return (
    <div className="mb-8">
      <div className="relative pt-6">
        ...
        <div className="mt-4 pt-3 pb-0 mb-0 border-t border-gray-200">
          <button
            onClick={() => {
            ...
            className="flex-center gap-2 w-full text-blue-600 hover:text-blue-800 font-medium text-sm transition-colors duration-200"
          >
